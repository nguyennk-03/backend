            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('xac-nhan-mat-khau') }}">
                            @csrf
                            <div class="row mb-3">
                                <label for="password"
                            ...
                            <div class="row mb-0">
                                <div class="col-md-8 offset-md-4">
                                    <button type="submit" class="btn btn-primary">{{ __('Xác nhận mật khẩu') }}</button>
                                    @if (Route::has('quen-mat-khau'))
                                        <a class="btn btn-link"
                                            href="{{ route('quen-mat-khau') }}">{{ __('Quên mật khẩu?') }}</a>
                                    @endif
                                </div>
                            </div>
                        </form>
