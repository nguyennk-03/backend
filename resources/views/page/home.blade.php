          ...
          <section class="section collection">
            <div class="container">
              ...
              <ul class="collection-list has-scrollbar">
                ...
                <li>
                  <div class="collection-card" style="background-image: url('{{asset('images/collection-1.jpg')  }}')">
                ...
                <li>
                  <div class="collection-card" style="background-image: url('{{asset('images/collection-2.jpg')  }}')">
                ...
                <li>
                  <div class="collection-card" style="background-image: url('{{asset('images/collection-3.jpg')  }}')">
              ...
              <ul class="product-list">
                ...
                <li class="product-item">
                  <div class="product-card" tabindex="0">
                    ...
                    <figure class="card-banner">
                      <img src="{{asset('images/product-1.jpg')  }}" width="312" height="350" loading="lazy"
                ...
                <li class="product-item">
                  <div class="product-card" tabindex="0">
                    ...
                    <figure class="card-banner">
                      <img src="{{asset('images/product-2.jpg')  }}" width="312" height="350" loading="lazy"
                ...
                <li class="product-item">
                  <div class="product-card" tabindex="0">
                    ...
                    <figure class="card-banner">
                      <img src="{{asset('images/product-3.jpg')  }}" width="312" height="350" loading="lazy"
                ...
                <li class="product-item">
                  <div class="product-card" tabindex="0">
                    ...
                    <figure class="card-banner">
                      <img src="{{asset('images/product-4.jpg')  }}" width="312" height="350" loading="lazy"
                ...
                <li class="product-item">
                  <div class="product-card" tabindex="0">
                    ...
                    <figure class="card-banner">
                      <img src="{{asset('images/product-5.jpg')  }}" width="312" height="350" loading="lazy"
                ...
                <li class="product-item">
                  <div class="product-card" tabindex="0">
                    ...
                    <figure class="card-banner">
                      <img src="{{asset('images/product-6.jpg')  }}" width="312" height="350" loading="lazy"
                ...
                <li class="product-item">
                  <div class="product-card" tabindex="0">
                    ...
                    <figure class="card-banner">
                      <img src="{{asset('images/product-7.jpg')  }}" width="312" height="350" loading="lazy"
                ...
                <li class="product-item">
                  <div class="product-card" tabindex="0">
                    ...
                    <figure class="card-banner">
                      <img src="{{asset('images/product-8.jpg')  }}" width="312" height="350" loading="lazy"
                        alt="Simple Fabric Shoe" class="image-contain">
          ...
          <section class="section insta-post">
            ...
            <ul class="insta-post-list has-scrollbar">
              ...
              <li class="insta-post-item">
                <img src="{{asset('images/insta-1.jpg')  }}" width="100" height="100" loading="lazy" alt="Instagram post"
              ...
              <li class="insta-post-item">
                <img src="{{asset('images/insta-2.jpg')  }}" width="100" height="100" loading="lazy" alt="Instagram post"
                  class="insta-post-banner image-contain">
              ...
              <li class="insta-post-item">
                <img src="{{asset('images/insta-3.jpg')  }}" width="100" height="100" loading="lazy" alt="Instagram post"
                  class="insta-post-banner image-contain">
              ...
              <li class="insta-post-item">
                <img src="{{asset('images/insta-4.jpg')  }}" width="100" height="100" loading="lazy" alt="Instagram post"
                  class="insta-post-banner image-contain">
              ...
              <li class="insta-post-item">
                <img src="{{asset('images/insta-5.jpg')  }}" width="100" height="100" loading="lazy" alt="Instagram post"
                  class="insta-post-banner image-contain">
              ...
              <li class="insta-post-item">
                <img src="{{asset('images/insta-6.jpg')  }}" width="100" height="100" loading="lazy" alt="Instagram post"
                  class="insta-post-banner image-contain">
              ...
              <li class="insta-post-item">
                <img src="{{asset('images/insta-7.jpg')  }}" width="100" height="100" loading="lazy" alt="Instagram post"
                  class="insta-post-banner image-contain">
              ...
              <li class="insta-post-item">
                <img src="{{asset('images/insta-8.jpg')  }}" width="100" height="100" loading="lazy" alt="Instagram post"
                  class="insta-post-banner image-contain">
