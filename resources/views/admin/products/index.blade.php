...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-4 d-flex align-items-end justify-content-end">
            <button type="button" class="btn btn-success btn-sm fw-semibold shadow-sm" data-bs-toggle="modal" data-bs-target="#addProductModal">
    ...
    <!-- Modal thêm sản phẩm -->
    <div class="modal fade" id="addProductModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="gamingModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content rounded-lg shadow-lg">
                <div class="modal-header">
                    <h5 class="modal-title fw-bold" id="gamingModalLabel"><i class="fas fa-plus-circle me-2"></i> Thêm sản phẩm mới</h5>
                    ...
                    <form action="{{ route('san-pham.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="price" id="price" class="form-control border-0 shadow-sm" value="{{ old('price') }}" placeholder="Nhập giá sản phẩm" min="0" required>
                                @error('price')
                                <span class="text-danger small">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="number" name="stock" id="stock" class="form-control border-0 shadow-sm" value="{{ old('stock', 0) }}" placeholder="Nhập số lượng" min="0">
                                @error('stock')
                                <span class="text-danger small">{{ $message }}</span>
                                @enderror
                            </div>
                                                ...
                                                <form action="{{ route('san-pham.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="row g-4">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="number" name="price" id="price_{{ $item->id }}" class="form-control border-0 shadow-sm" value="{{ old('price', $item->price) }}" placeholder="Nhập giá sản phẩm" min="0" required>
                                                            @error('price')
                                                            <span class="text-danger small">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="number" name="stock" id="stock_{{ $item->id }}" class="form-control border-0 shadow-sm" value="{{ old('stock', $item->total_stock) }}" placeholder="Nhập số lượng tồn kho" min="0" required>
                                                            @error('stock')
                                                            <span class="text-danger small">{{ $message }}</span>
                                                            @enderror
                                                        </div>
